...
//	dObj.bpri = 40;			client.cpp(19) : error C2248: 'base::bpri' : cannot access private member declared in class 'base'
//	dObj.bpro = 50;			client.cpp(20) : error C2248: 'base::bpro' : cannot access protected member declared in class 'base'
	dObj.bpub = 160;
	dObj.Display();
